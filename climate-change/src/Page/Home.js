     ...
     <Col style={{marginRight:"100px"}}>
      <div>
         ...
         {/* <input style={{ marginTop: "10px", borderRadius: "5px" }} onChange={handleClimateDetails} type="textArea" placeholder="Enter climate details" value={ClimateDet} /> <br /> */}
                   <textarea rows="3" cols="40" name="comment" placeholder="Enter climate Details" style={{backgroundColor:''}} onChange={handleClimateDetails} value={ClimateDet}></textarea>
         <Button onClick={handleClimate} style={{ marginTop: "10px" }} variant="primary"> Add Climate Data</Button>
      </div>
     </Col>
      <Col>
         <div>
                   <textarea rows="3" cols="40" name="comment" placeholder="Update existing climate Details" onChange={handleUpdatedClimateDetails} value={UpdateClimateDetails}></textarea>
